...
snake_size = 40
if character == "23chafai.png" or character == "23morabito.png" : #Increase size according to lore
    snake_size += 10
...
#Define Microtransaction properties
bg_color = (0, 0, 0)
...
credits_lines = [
    ...
    {"text": "Developpé par VsCode, Aria Chafaï et Luca Morabito", "font": credits_font_normal},
    {"text": "Physics Engine de Pygame (Meilleur que Unreal Engine)", "font": credits_font_normal},
    {"text": "Avec la Collaboration de MatMaz et Béa", "font": credits_font_normal},
    {"text": "Grand Merci à Minecraft et Metal Gear Solid pour la Bande Sonore", "font": credits_font_normal},
    {"text": "Grand Merci à Rick Astley pour le cover 'Never gonna give you up'", "font": credits_font_normal},
    {"text": "Et un GRAND MERCI A TOI POUR Y AVOIR JOUE!", "font": credits_font_normal},
    {"text": "", "font": credits_font_normal},
    {"text": "PS. Une bonne note sera appréciée (Merci !)", "font": credits_font_normal},
